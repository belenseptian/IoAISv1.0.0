...
<body>
    ...
    <!-- chart chartist js -->
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/chartist-bundle/chartist.min.js"></script>
    <!-- sparkline js -->
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <!-- morris js -->
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/morris-bundle/raphael.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/morris-bundle/morris.js"></script>
    <!-- chart c3 js -->
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/c3charts/c3.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/c3charts/d3-5.4.0.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/vendor/charts/c3charts/C3chartjs.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/libs/js/dashboard-ecommerce.js"></script>
    <script type="text/javascript" language="javascript" src="<?php echo e(url('/')); ?>/js/jquery.dataTables.min.js"></script>
    <script>
        $.ajaxSetup({
...
</html><?php /**PATH /var/www/html/ais/resources/views/backend/master.blade.php ENDPATH**/ ?>